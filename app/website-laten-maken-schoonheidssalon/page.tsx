...
export const metadata = {
  title: "Website laten maken voor schoonheidssalons | Tinsights",
  description: "Professionele website voor schoonheidssalons. Behandelingen, boekingen en meer.",
      ...
      >
        ...
        <div style={{ position: "relative", zIndex: 1, maxWidth: 680, margin: "0 auto" }}>
          ...
          <p style={{ fontSize: 17, lineHeight: 1.75, color: "rgba(255,255,255,0.55)", maxWidth: 520, margin: "0 auto 40px" }}>
            Professionele website voor schoonheidssalons. Behandelingen, boekingen en meer.
          </p>
